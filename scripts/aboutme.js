...
function modalShow(tipo){
    ...
    switch(tipo) {
        ...
        case 5:
            ...
            <img class=foto_galeria src=../resources/galeria/abejita.jpg onclick="window.open('../resources/galeria/abejita.jpg','_blank').focus();">
            <p class=foto_tag>"abejita" 13/07/2025 Soria</p>
            <img class=foto_galeria src=../resources/galeria/amigo.jpg onclick="window.open('../resources/galeria/amigo.jpg','_blank').focus();">
            <p class=foto_tag>"amigo" 26/04/2025 Peñagrande</p>
            <img class=foto_galeria src=../resources/galeria/ojo.jpg onclick="window.open('../resources/galeria/ojo.jpg','_blank').focus();">
            <p class=foto_tag>"ojo" 31/12/2024 Segovia</p>
            <img class=foto_galeria src=../resources/galeria/sistema_nervioso.jpg onclick="window.open('../resources/galeria/sistema_nervioso.jpg','_blank').focus();">
            <p class=foto_tag>"sistema nervioso" 31/12/2024 Segovia</p>
            <img class=foto_galeria src=../resources/galeria/planeta.jpg onclick="window.open('../resources/galeria/planeta.jpg','_blank').focus();">
            <p class=foto_tag>"planeta" 05/05/2023 Soria</p>
                `;
            break;
        case 6:
